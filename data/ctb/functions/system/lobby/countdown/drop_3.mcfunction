...
setblock 214 60 78 minecraft:structure_block[mode=load]{ignoreEntities:1b,posX:0,mode:"LOAD",posY:-5,sizeX:32,posZ:0,name:"ctb:above_arena/team_structure_green",sizeY:5,sizeZ:11,showboundingbox:0b} replace
